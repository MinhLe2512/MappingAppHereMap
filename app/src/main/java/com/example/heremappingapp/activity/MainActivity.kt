...
//    }
    ...
    private fun internetConnectivity(): Boolean {
    ...
    private fun locationTrackingEnabled(): Boolean {
...
//    }
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == REQUEST_LOCATION_SETTINGS || requestCode == REQUEST_WIFI_CONNECTION) {
            checkSettings()
        }
    }
